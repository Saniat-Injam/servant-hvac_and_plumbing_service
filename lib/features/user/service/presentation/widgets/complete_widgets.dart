    ...
    return Expanded(
      child:
        ...
        Obx((){
          ...
          final inCompleteList = controller.completedDetails.value.result?.data ?? [];
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomElevatedButtonWidget(buttonTitle: "Rating & Review",onPressed: (){
                  Get.toNamed(AppRoute.ratingScreen,arguments: {
